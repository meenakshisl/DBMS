...
1. Create tables based on the following schema. Don’t forget to mention the constraints – primary key and foreign key.
2. Also, give the check, unique, default and not null constraints where ever required.
3. Insert data as per given below:
```
...
5. Find the average salary of each department if this is more than 40000
6. Find the number of employees in department number 6.
7. Find the number of employees of each department of those employees whose name starts with ‘J’
8. Find the number of projects for each department.
